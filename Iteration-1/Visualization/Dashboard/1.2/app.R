...
server <- function(input, output, session) {
  ...
  output$plot_common_text <- renderUI({
    ...
    &ensp; &ensp; &ensp;10. Recurrent depression, click <a href="https://www.medicalnewstoday.com/articles/320269">here</a> <br>
    
    For more details on Public hospitals, click <a href="https://www1.health.gov.au/internet/main/publishing.nsf/Content/hospitals2.html">here</a>.     
