...
ui <- dashboardPage(
  ...
  dashboardHeader(title = ""), # Name of the project
  dashboardSidebar(sidebarMenu(
    # All the Dashboard menu items 
    menuItem("Hospitals", tabName = "hospital", icon = icon("hospital")) 
  )),
  ...
  dashboardBody(
    ...
    tabsetPanel(
      tabItem(tabName = "hospital", tabBox(height = "5000px", width = "3000px",
                                           
                                           
                                           tabPanel("Common mental issues", h1("Common mental diagnosis across public and private hospital in Australia"),
                                                    ...
                                                    tabItem(tabName = "hospital",
                                                            fluidRow(
                                                              ...
                                                              box(
                                                                title = "Input", background = "navy",  solidHeader = TRUE,
                                                                collapsible = TRUE,
                                                                selectInput(
                                                                  "selection",
                                                                  "Select hospitals",
                                                            ...
                                                            column(12, style = "padding-top:20px;",
                                                              box(
                                                                title = "Info", background = "black", solidHeader = TRUE,
                                           ...
                                           tabPanel("A tale of the past", h1("A tale of the past"), 
                                                    p("Know more about how have people gone about identifying their mental health issue
                                                       with either specialized psychiatric care and without. What exactly do you need to know
                                                       about this statistical information? What hidden story is the below graph trying to tell you? Is it just another boring graph? 
                                                       Lets find out... But first take a jab at changing the type of care & age-group under the black boxes.... 
                                                    ...
                                                    tabItem(tabName = "hospital",
                                                            fluidRow(
                                                              ...
                                                              box(
                                                                title = "Line graph", status = "primary", solidHeader = TRUE,
                                                                collapsible = TRUE,
                                           ...
                                           tabPanel("Professional help", h2("How well does professional help assist you?"),
                                                    tabItem(tabName = "hospital",
                                                            fluidRow(
                                                              ...
                                                              box(
                                                                title = "Column bar graph", status = "primary", solidHeader = TRUE,
                                                                collapsible = TRUE,
